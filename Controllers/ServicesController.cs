...
namespace BeautySoul_Core.Controllers
{
    ...
    public class ServicesController : ControllerBase
    {
        ...
        {
            return _context.Services.Include(m => m.serviceCategory);
        }
        ...
        public async Task<IActionResult> GetService([FromRoute] int id)
        {
            ...
            var service = await _context.Services.Include(m=>m.serviceCategory).SingleOrDefaultAsync(m=>m.serviceId== id);
